...
ADMIN_USERNAME = os.environ.get("ADMIN_USERNAME", "ASAAQI")
ADMIN_PASSWORD = os.environ.get("ADMIN_PASSWORD", "2026ASAA")
ADMIN_WHATSAPP = os.environ.get("ADMIN_WHATSAPP", "2250150070083")
DB_PATH = Path(os.environ.get("DB_PATH", str(BASE_DIR / "data.sqlite")))
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if path == "/api/register":
            ...
            redirect = f"https://wa.me/{ADMIN_WHATSAPP}?text={quote(msg)}"
